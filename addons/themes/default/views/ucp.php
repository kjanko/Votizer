				...
				<div id="menu2" class="tab-pane fade">
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input id="url" class="form-control ucp" required type="text" value="{$site.url}" placeholder="http://"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input id="title" class="form-control ucp" required type="text" value="{$site.title}" placeholder="Title"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control ucp" id="description" rows="6" required placeholder="Description">{$site.description}</textarea>
							</div>
						</div>
				...
				<div id="menu3" class="tab-pane fade in active">
					...
					<div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="username" class="form-control ucp" required type="text" placeholder="Username" readonly value="{$user.username}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="name" class="form-control ucp" required type="text" placeholder="Name" value="{$user.name}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="surname" class="form-control ucp" required type="text" placeholder="Surname" value="{$user.surname}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="email" class="form-control ucp" required type="text" placeholder="Email" value="{$user.email}"/>
                            </div>
                        </div>
