...
$config['asset_dir'] = '/addons/themes/';
...
$config['asset_url'] = config_item('base_url').'addons/themes/';
...
$config['theme_asset_dir'] = 'addons/themes/';
...
$config['theme_asset_url'] = config_item('base_url').'addons/themes/';
