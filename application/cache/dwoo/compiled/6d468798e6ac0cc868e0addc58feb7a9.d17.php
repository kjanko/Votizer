	...
	<div class="panel-body" style="padding: 20px 20px 0">
		...
		<div class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" id="username" required type="text" placeholder="Name"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" id="password" required type="password" placeholder="Password"/>
				</div>
			</div>
