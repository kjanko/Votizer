			...
			<div class="content-module">
				...
				<div class="content-module-main">
					...
					<table>
						...
						<tbody id="users">
							<?php 
$_fh0_data = (isset($this->scope["sites"]) ? $this->scope["sites"] : null);
...
?>
							<tr id="<?php echo $this->scope["val"]["id"];?>">
								...
								<td><a href="#" onclick="showEditUser('<?php echo $this->scope["val"]["username"];?>','sites')"><?php echo $this->scope["val"]["username"];?></td>
								<td><?php echo $this->scope["val"]["title"];?></td>
								<td><?php echo $this->scope["val"]["category_id"];?></td>
								<td><?php echo $this->scope["val"]["in_votes"];?></td>
								<td><?php echo $this->scope["val"]["out_votes"];?></td>
								<td>
									<?php if ((isset($this->scope["val"]["premium"]) ? $this->scope["val"]["premium"]:null) == 1) {
?>
										True
									<?php 
}
...
?>
								...
								<td>
									<a href="#" class="table-actions-button ic-table-edit" onclick="showEditSite(<?php echo $this->scope["val"]["id"];?>)"></a>
									<a href="#" class="table-actions-button ic-table-delete" onclick="removeSite(<?php echo $this->scope["val"]["id"];?>)"></a>
								</td>
							</tr>
							<?php 
/* -- foreach end output */
