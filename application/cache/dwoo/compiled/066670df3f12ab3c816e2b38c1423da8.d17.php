...
?>
					<li><a href="<?php echo $this->scope["val"]["link_url"];?>"><?php echo $this->scope["val"]["link_name"];?></a></li>
				<?php 
/* -- foreach end output */
	}
}?>
			...
			<div class="side-content fr">
				...
				<div class="half-size-column fl">
					...
					<div class="content-module">
						...
						<?php 
$_fh1_data = (isset($this->scope["feeds"]) ? $this->scope["feeds"] : null);
				...
				<div class="half-size-column fl">
					...
					<div class="content-module">
						...
						<div class="content-module-main">
							...
							<p>PHP Version: 5.3.10</p>
							<p>CMS Version: 0.1.3 [Alpha]</p>
							<p>Loading Time: 2.0238</p>
							<p>Memory Usage: 4431 KB</p>
							<div class="confirmation-box round"> mod_rewrite is enabled! </div>							<div class="warning-box round"> Remote updater is under development! </div>
							<div class="stripe-separator"><!-- --></div>
							
							<h1>User Activity</h1>
							<div>
								<img src="https://chart.googleapis.com/chart?chf=bg,s,FFFFFF&chxl=0:|<?php echo $this->scope["graph"]["first_date"];?>|<?php echo $this->scope["graph"]["last_date"];?>&chxp=0,12,87&chxr=1,0,<?php echo $this->scope["graph"]["top"];?>&chxs=1,676767,11.5,0,lt,676767&chxt=x,y&chs=450x190&cht=lc&chco=095a9d&chds=0,<?php echo $this->scope["graph"]["top"];?>&chd=t:<?php echo $this->scope["graph"]["stack"];?>&chdlp=l&chls=2&chma=5,5,5,5" />
							</div>
						</div> <!-- end content-module-main -->
