	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="<?php echo base_url(); ?>acp/dashboard/subscriptions" class="active-tab dashboard-tab">Subscription</a></li>
			</ul> <!-- end tabs -->
		...
		<div class="page-full-width cf">
			...
			<div class="content-module">
				...
				<div class="content-module-main">
					<p>Here you can list all of the premium subscribers. In order to manually make a site premium go <a href="<?php echo base_url(); ?>acp/dashboard/sites">here</a>.</p>
